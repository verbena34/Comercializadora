...
export const mockUsers = [
  {
    id: "admin1",
    name: "Administrador",
    email: "admin@emprende360.com",
    role: "admin",
    active: true,
  },
  { id: "emp1", name: "Juan Pérez", email: "juan@emprende360.com", role: "employee", active: true },
  {
    id: "emp2",
    name: "María García",
    email: "maria@emprende360.com",
    role: "employee",
    active: true,
  },
  {
